      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
          <div className="footer-section space-y-6">
            <h3 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-red-500">Pepsi</h3>
          ...
          <div className="footer-section space-y-6">
            ...
            <form ref={formRef} className="flex flex-col space-y-3">
              ...
              <button type="submit" className="bg-red-600 text-white px-6 py-3 rounded-md hover:bg-red-700 transition-colors duration-300 transform hover:scale-105">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 text-center text-gray-300 text-sm">
          <p>&copy; {new Date().getFullYear()} Asap developers. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

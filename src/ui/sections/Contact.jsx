...
const Contact = () => {
  ...
  return (
    <div className=" w-11/12 mx-auto p-4 relative overflow-hidden" id="Contact">
      <span className=" ch z-10  text-[6vmax] font-bold lg:font-semibold absoute top-0  lg:left-32">
        <span className="text-primary">Get</span> in Touch{" "}
      </span>
      <span className="ch text-[7vmax] font-bold lg:font-semibold absolute top-14 lg:top-28 left-[20%] lg:left-[38%]">
        with <span className="text-secondary">Us</span>
      </span>

      <div className=" flex flex-col lg:flex-row justify-center gap-2 mt-20 lg:mt-40 w-full p-4 ">
        <div className="info w-full lg:w-2/5  flex flex-col gap-6 mt-4 text-sm">
          <p>
      ...
      <div className="w-full lg:w-[30%] flex text-justify text-xs lg:absolute lg:bottom-10 lg:left-20 mt-10 p-2">
